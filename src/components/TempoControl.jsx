  ...
  return (
    <ControlRow label="Tempo" value={`${tempo} BPM`}>
      <div className="flex items-center gap-2.5">
        ...
        <button
          className="font-mono text-[11px] tracking-wider uppercase text-muted bg-transparent border border-line rounded-lg px-2.5 py-1.5 cursor-pointer flex-shrink-0 hover:text-brass-bright hover:border-brass focus-visible:outline focus-visible:outline-2 focus-visible:outline-brass-bright focus-visible:outline-offset-2"
          onClick={handleTap}
        >
          Tap
        </button>
